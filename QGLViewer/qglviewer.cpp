...
void QGLViewer::renderText(int x, int y, const QString& str, const QFont& font)
{
...
void QGLViewer::renderText(double x, double y, double z, const QString& str, const QFont& font)
{
