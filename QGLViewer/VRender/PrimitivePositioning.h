...
// This class implements a static method for positioning two primitives relative
// to each other.

class PrimitivePositioning {
public:
  typedef enum { Independent = 0x0, Upper = 0x1, Lower = 0x2 } RelativePosition;
  ...
  static void split(Segment *S, const NVector3 &v, double C, Primitive *&P_plus,
                    Primitive *&P_moins);
