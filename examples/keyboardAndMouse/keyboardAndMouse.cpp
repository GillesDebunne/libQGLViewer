...
void Viewer::init()
{
  ...
  setShortcut(EXIT_VIEWER, CTRL+Key_Q);

  // Set 'Control+F' as the FPS toggle state key.
  setShortcut(DISPLAY_FPS, CTRL+Key_F);
  ...
  setKeyDescription(Key_W, "Toggles wire frame display");
  setKeyDescription(Key_F, "Toggles flat shading display");
