# An AxisConstraint class with a limited rotation range

TEMPLATE = app
TARGET   = rangeAxisConstraint
CONFIG  += console qt opengl warn_on release thread

HEADERS  = viewer.h rangeAxisConstraint.h 
SOURCES  = viewer.cpp rangeAxisConstraint.cpp main.cpp
...
#win32:LIBS *= QGLViewer223.lib (with Visual 6, use QGLViewer2.lib or QGLViewer.lib instead)
...
win32 {
  ...
  exists( $${LIB_PATH}/QGLViewer223.lib ) {
    LIBS *= $${LIB_PATH}/QGLViewer223.lib
  } else {
